    ...
    return (
        <nav className="p-4 bg-transparent text-white flex items-center " style={{ zIndex: 500, backgroundColor: 'transparent', position: 'relative', pointerEvents: 'auto' }}>
            <Link href="/" className="mr-4 flex items-center">
                ...
                <span className="text-white text-3xl font-bold">Typhoon</span>
            </Link>
            ...
            <a target="_blank" rel="noopener noreferrer" href='https://typhoon-2.gitbook.io/typhoon-docs' className="ml-4"><span className='text-base font-semibold text-white hover:text-blue-500'>Docs</span></a>
        </nav>
    );
}